...
.lesson-page :where(a, button, input, textarea, select, [role="button"]) {
...
.lesson-page :where(a, button, input, textarea, select, [role="button"]):focus-visible {
  outline: 3px solid rgba(159, 25, 69, .22) !important;
  outline-offset: 3px;
}

.lesson-page :where(button, [role="button"], .button, .btn):not(:disabled):active {
  transform: translateY(1px) scale(.99);
}

.lesson-page :where(input, textarea, select) {
  font-size: max(16px, 1em);
}

.lesson-page :where(table tbody tr) {
  transition: background-color .18s ease;
}

.lesson-page :where(table tbody tr):hover {
  background-color: rgba(159, 25, 69, .025);
}

.lesson-page :where(.card, [class*="-card"], [class*="__card"]) {
  transition: transform .24s cubic-bezier(.2,.75,.25,1), box-shadow .24s ease, border-color .24s ease;
}

.lesson-page :where(.card, [class*="-card"], [class*="__card"]):hover {
...
.lesson-page :where(input, textarea, select):focus {
  transform: translateY(-1px);
}
